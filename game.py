...
class TicTacToe:
    """Class for the Tic-Tac-Toe game. It is used to keep track of the board and make any moves that could go
        on the board. Also keeps track if the game is over and who the winner is."""
    ...
    def move(self, move: int, letter: str) -> bool:
        """Takes a move and letter as input and tries to make the move on the board. ex: move(1, 'X')"""
